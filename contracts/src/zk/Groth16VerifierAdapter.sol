...
contract Groth16VerifierAdapter is Ownable, Initializable, UUPSUpgradeable {
    ...
    function initializeProxy(address owner_, address verifier_) external initializer {
